...
from zotero_cli_agents.models import Collection, DuplicateGroup, ErrorInfo, Item, Note
...
def print_error(error: str | ErrorInfo, output_json: bool = False) -> None:
    ...
    Does not exit. Use zotero_cli_agents.exit_codes.emit_error when you want to exit.
    """
    import sys as _sys
