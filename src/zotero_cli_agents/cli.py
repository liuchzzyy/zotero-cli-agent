...
from zotero_cli_agents.commands.add import add_cmd
from zotero_cli_agents.commands.attach import attach_cmd
from zotero_cli_agents.commands.cite import cite_cmd
from zotero_cli_agents.commands.collection import collection_group
from zotero_cli_agents.commands.completions import completions_cmd
from zotero_cli_agents.commands.config import config_group
from zotero_cli_agents.commands.delete import delete_cmd
from zotero_cli_agents.commands.duplicates import duplicates_cmd
from zotero_cli_agents.commands.export import export_cmd
from zotero_cli_agents.commands.list_cmd import list_cmd
from zotero_cli_agents.commands.mcp import mcp_group
from zotero_cli_agents.commands.note import note_cmd
from zotero_cli_agents.commands.open_cmd import open_cmd
from zotero_cli_agents.commands.pdf import pdf_cmd
from zotero_cli_agents.commands.read import read_cmd
from zotero_cli_agents.commands.recent import recent_cmd
from zotero_cli_agents.commands.relate import relate_cmd
from zotero_cli_agents.commands.schema import schema_cmd
from zotero_cli_agents.commands.search import search_cmd
from zotero_cli_agents.commands.stats import stats_cmd
from zotero_cli_agents.commands.summarize import summarize_cmd
from zotero_cli_agents.commands.summarize_all import summarize_all_cmd
from zotero_cli_agents.commands.tag import tag_cmd
from zotero_cli_agents.commands.trash import trash_group
from zotero_cli_agents.commands.update import update_cmd
from zotero_cli_agents.commands.update_status import update_status_cmd
from zotero_cli_agents.commands.workspace import workspace_group
...
def main(
    ...
    from zotero_cli_agents.formatter import request_scope
...
def _after_command(ctx: click.Context, *_args: object, **_kwargs: object) -> None:
    ...
    if obj.get("json") or obj.get("no_interaction") or not sys.stderr.isatty():
        return
    from zotero_cli_agents import __version__
    from zotero_cli_agents.core.version_check import check_for_update, upgrade_command
