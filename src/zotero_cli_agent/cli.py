...
from zotero_cli_agent.commands.completions import completions_cmd
...
from zotero_cli_agent.commands.read import read_cmd
from zotero_cli_agent.commands.recent import recent_cmd
from zotero_cli_agent.commands.relate import relate_cmd
from zotero_cli_agent.commands.schema import schema_cmd
from zotero_cli_agent.commands.search import search_cmd
from zotero_cli_agent.commands.stats import stats_cmd
from zotero_cli_agent.commands.summarize import summarize_cmd
from zotero_cli_agent.commands.summarize_all import summarize_all_cmd
from zotero_cli_agent.commands.tag import tag_cmd
from zotero_cli_agent.commands.trash import trash_group
from zotero_cli_agent.commands.update import update_cmd
from zotero_cli_agent.commands.update_status import update_status_cmd
from zotero_cli_agent.commands.workspace import workspace_group
...
def main(
    ...
    from zotero_cli_agent.formatter import request_scope
...
def _after_command(ctx: click.Context, *_args: object, **_kwargs: object) -> None:
    ...
    if obj.get("json") or obj.get("no_interaction") or not sys.stderr.isatty():
        return
    from zotero_cli_agent import __version__
    from zotero_cli_agent.core.version_check import check_for_update, upgrade_command
