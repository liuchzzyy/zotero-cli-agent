...
from zotero_cli_agent.formatter import emit_progress, envelope_ok, envelope_partial
...
def add_cmd(
    ...
    from zotero_cli_agent.core.idempotency import get_cached, store_cached
