...
from zotero_cli_agent.models import Collection, Item, Note
...
def _handle_add(doi: str | None, url: str | None, library: str = "user") -> dict:
    ...
    from zotero_cli_agent.core.metadata_resolver import MetadataResolveError, resolve_doi
...
def _handle_cite(key: str, style: str = "apa", library: str = "user") -> dict:
    from zotero_cli_agent.commands.cite import STYLES
...
def _handle_update_status(
    ...
    from zotero_cli_agent.core.semantic_scholar import SemanticScholarClient, extract_preprint_info
