...
def test_external_resolution_builds_safe_operation_from_google() -> None:
    ...
    operation = build_operation_from_resolution(item, resolution, add_tag="workflow/book_metadata_update")
    ...
    assert operation["tags_to_add"] == ["workflow/book_metadata_update"]
