...
from zotero_cli_agent.config import get_data_dir, load_ai_note_config, load_config, resolve_write_credentials
...
DEFAULT_PROMPT_PATH = Path(__file__).resolve().parents[2] / "tools" / "templates" / "citation-key-from-ai-notes-prompt.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="JSON prompt file. Default: tools/templates/citation-key-from-ai-notes-prompt.json.",
    )
